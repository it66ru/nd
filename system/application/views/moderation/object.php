	...
	<form method="post">
		<div class="clear">
			<div class="block w300">
				Тип объявления <span class="red">*</span> :
				<?=form_dropdown('type', $this->Mobject->form_data['obj_type'], $this->Mobject->data['type']);?>
			</div>
			<? if ($this->Mobject->parse) { ?>
				<div class="block w300" style="font-size:16px">
					...
					&nbsp; / &nbsp;
					<a target="_blank" href="/cron_avito/get_info/<?=$this->Mobject->parse['id']?>">обновить</a>
				</div>
			<? } ?>
		</div>
		<div class="clear">
			<div class="block">
				...
				<input name="ul" type="text" value="<?=$this->Mobject->data['ul']?>" class="w250" id="street">
			</div>
			<div class="block">
