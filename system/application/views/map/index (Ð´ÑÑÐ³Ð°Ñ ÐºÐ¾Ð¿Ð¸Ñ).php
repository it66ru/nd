...
//		objManager.add(getPoints(10, "default#redPoint"), 8, 10);
		...
		function makePointZoom(data)
		{
			...
			objManager.add(pz, map.getZoom(), map.getZoom());
		}
...
<body>
	...
	<div id="YMap"></div>
	<div id="info" style="background:#eef; border:1px solid #f00; float:left; margin-left:10px"></div>
</body>
</html>
